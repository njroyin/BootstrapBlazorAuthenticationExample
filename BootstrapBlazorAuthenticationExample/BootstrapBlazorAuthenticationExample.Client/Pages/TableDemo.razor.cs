...
using BootstrapBlazorAuthenticationExample.Client.Data;
using Microsoft.AspNetCore.Components;
using Microsoft.Extensions.Localization;
using System.Collections.Concurrent;
using System.Diagnostics.CodeAnalysis;

namespace BootstrapBlazorAuthenticationExample.Client.Pages;
...
public partial class TableDemo : ComponentBase
{
    ...
    private IEnumerable<SelectedItem> GetHobbies(Foo item) =>
        _cache.GetOrAdd(item, f => Foo.GenerateHobbies(Localizer));
